    ...
    const myvar = `${'<!DOCTYPE html>'
      ...
      + '</html>';
       ...
       + '<body>'
        ...
        +'To ensure your account''''s security and proceed with the login process, we require verification of your identity.</br></br>'
        ...
        +'If you did not request this OTP or have concerns about your account''''s security, please contact our support team immediately at'}${supportData}'.</br></br>'
